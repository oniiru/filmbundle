...
class stag_section_slidetop extends WP_Widget{
 ...
 $image = wp_get_attachment_url( get_post_thumbnail_id($page) );
    ...
    <section id="<?php echo stag_to_slug($id); ?>"  class="section-block content-section midsect" style="background-image:url('<?php echo $image; ?>')" data-link="<?php echo $link; ?>">
      ...
      <div class="inner-section">
		...
		jQuery(".midsect:first").addClass('firstmidsect');
		});
		</script>
      </div>
