...
function stag_twitter_js(){
  wp_enqueue_script('jquery');
  wp_enqueue_script('stag-twitter-widget', get_template_directory_uri().'/assets/js/twitter.js', '', '', true);
}
add_action('wp_enqueue_scripts', 'stag_twitter_js');