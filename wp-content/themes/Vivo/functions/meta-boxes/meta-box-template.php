...
function add_custom_meta_box() {
    add_meta_box(
		'custom_meta_box', // $id - for CSS styling
		'Custom Meta Box', // $title - displayed in handle of box
		'show_custom_meta_box', // $callback - function used to define output inside box
...
$custom_meta_fields = array(
	...
	array(
		...
		'type'	=> 'select',
		'options' => array (
			//Ensure option key and value are identical here
			'one' => array (
				'label' => 'Option One',
				'value'	=> 'one'
			),
