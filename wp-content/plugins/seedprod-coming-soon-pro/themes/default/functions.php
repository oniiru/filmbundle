...
function seed_cs3_form(){
	...
	if(in_array('0',$share_buttons['buttons'])){
		$output .= '<li id="share_twitter"><a id="twitter-tweet-btn" class="twitter-share-button" data-url="'.$ref_link.'" data-text="'.esc_attr($share_buttons['tweet_text']).' '.$ref_link.'" data-count="none">Tweet</a>';
