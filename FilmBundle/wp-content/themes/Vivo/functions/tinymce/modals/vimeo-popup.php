...
<head>
<title>Insert Vimeo Video</title>
...
var ButtonDialog = {
	...
	insert : function insertButton(ed) {
		...
		var vimeo = jQuery('#button-dialog textarea#button-text').val(); 
 
		var output = '';
 
		// setup the output of our shortcode
		output = '[vimeo vid="' + vimeo + '"]';
...
<body>
	<div id="button-dialog">
		<form action="/" method="get" accept-charset="utf-8">
			<div>
				<label for="button-text">Vimeo video ID </br></br><strong>EG. 49155684</strong></br></br>Can be found in the videos URL</label>
