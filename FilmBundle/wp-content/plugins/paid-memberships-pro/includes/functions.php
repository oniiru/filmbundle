<?php
	...
	function pmpro_getLevelCost(&$level, $tags = true)
	{
		global $pmpro_currency_symbol;
		  $init_price = $level->initial_payment;
                if(isset($_SESSION['pwyw_bundle_price'])&&(float)$_SESSION['pwyw_bundle_price']>0){
                    $init_price = $_SESSION['pwyw_bundle_price'];
                }
		$r = '
		Your contribution of <strong>' . $pmpro_currency_symbol . number_format( $init_price, 2) . '</strong> goes a long way. Thanks for supporting Independent Film';
