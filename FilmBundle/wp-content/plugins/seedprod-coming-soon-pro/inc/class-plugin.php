...
class SEED_CSP3_PLUGIN extends SEED_CSP3 {
        ...
        if(check_ajax_referer('seed_csp3_refresh_list')){
            ...
            switch($provider){
                case 'madmini':
                    ...
                    global $seed_csp3_is_ajax;
                    $seed_csp3_is_ajax = true;
    ...
    function get_mailchimp_lists($apikey = null){
        global $seed_csp3,$seed_csp3_is_ajax;
        $o = $seed_csp3->get_settings();
        $lists = array();
        if($o['emaillist'] == 'mailchimp' || $seed_csp3_is_ajax){
    ...
    function get_madmini_lists($apikey = null, $username = null){
        ...
        $o = $seed_csp3->get_settings();
        $lists = array();
        if($o['emaillist'] == 'madmini' || $seed_csp3_is_ajax){
    ...
    function get_getresponse_lists($apikey = null){
        ...
        $o = $seed_csp3->get_settings();
        $lists = array();
        if($o['emaillist'] == 'getresponse' || $seed_csp3_is_ajax){
    ...
    function get_constantcontact_lists($username=null,$password=null){
        ...
        $o = $seed_csp3->get_settings();
        $lists = array();
        if($o['emaillist'] == 'constantcontact' || $seed_csp3_is_ajax){
    ...
    function get_campaignmonitor_lists($apikey = null,$clientid = null){
        ...
        $o = $seed_csp3->get_settings();
        $lists = array();
        if($o['emaillist'] == 'campaignmonitor' || $seed_csp3_is_ajax){
    ...
    function get_aweber_lists(){
        ...
        $o = $seed_csp3->get_settings();
        $lists = array();
        if($o['emaillist'] == 'aweber' || $seed_csp3_is_ajax){
