...
<div id="mc_signup">
	...
	<div class="mc_form_inside">
		...
		<div class="mc_signup_submit">
			<input type="submit" name="mc_signup_submit" id="mc_signup_submit" value="<?php echo esc_attr(get_option('mc_submit_text')); ?>" class="btn btn-info btn-large" />
...
<div class="mc_merge_var">
		...
		switch ($var['field_type']) {
			case 'date': 
				$html .= '
	<input placeholder='.$label.'type="text" size="20" value="'.esc_attr($var['default']).'" name="'.esc_attr($opt).'" id="'.esc_attr($opt).'" class="date-pick mc_input"/>';
				break;
			case 'radio':
	...
	<br /><select id="'.esc_attr($opt).'" name="'.esc_attr($opt).'" class="mc_select">';
		...
		<option value="'.esc_attr($value).'"'.selected($value, $var['default'], false).'>'.esc_html($value).'</option>';
			...
			case 'birthday':
				$html .= '
	<input type="text" placeholder='.$label.'type="text" size="20" value="'.esc_attr($var['default']).'" name="'.esc_attr($opt).'" id="'.esc_attr($opt).'" class="birthdate-pick mc_input"/>';
				break;
			case 'birthday-old':
				$days = range(1, 31);
	...
	<select name="'.esc_attr($opt.'[country]').'" id="'.esc_attr($opt.'-country').'">';
		...
		<option value="'.esc_attr($country_code).'"'.selected($country_code, $var['defaultcountry'], false).'>'.esc_html($country_name).'</option>';
			...
			case 'zip':
				$html .= '
	<input type="text" placeholder='.$label.'type="text" size="20" maxlength="5" value="" name="'.esc_attr($opt).'" id="'.esc_attr($opt).'" class="mc_input" />';
				break;
			case 'phone':
				$html .= '<br />
	...
	<input type="text" size="4" maxlength="4" value="" name="'.esc_attr($opt.'[detail2]').'" id="'.esc_attr($opt.'-detail2').'" class="mc_input mc_phone" />
			...
			default:
				$html .= '
	<input type="text" placeholder='.$label.'type="text" size="20" value="'.esc_html($var['default']).'" name="'.esc_attr($opt).'" id="'.esc_attr($opt).'" class="mc_input"/>';
				break;
		}
